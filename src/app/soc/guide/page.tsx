    ...
    <div className="container">
      <div className="max-h-[85dvh] space-y-4 overflow-auto px-4 py-4 text-justify">
        ...
        <p className="indent-8">
          ...
          and developed by a group of authors:{' '}
        ...
        <div>
          ...
          <ul className="list-disc pl-8">
            ...
            <li>
              <strong>STEP:</strong> Executes the SoC with one instruction implemented per session.
            </li>
            <li>
        ...
        <div className="space-y-4">
          <p className="indent-8">
            The SOC supports Assembly instructions based on the RISC-V instruction set architecture,
            including instruction formats such as R-type, I-type, S-type, B-type, U-type and J-type.
            You can refer to the image below for an overview of the instruction set architecture in
            RISC-V32I.
          </p>
          ...
          <p>
            ...
            operations based on two source registers, rs1 and rs2, with the result being written to
            the destination register rd.
          </p>
          <ul className="list-disc space-y-2 pl-8">
            <li>
              ADD: The ADD instruction performs an arithmetic addition between two source registers,
              Rs1 and Rs2, and writes the result into the destination register Rd.
            </li>
            ...
            <li>
              XOR: The XOR instruction performs bitwise “xor” between two source registers, Rs1 and
            ...
            <li>
              SRA: The SRA performs arithmetic right shift on the value in register Rs1 by the shift
              amount held in the lower 5 bits of register Rs2, and writes result into the
              destination register Rd.
            </li>
          ...
          <ul className="list-disc space-y-2 pl-8">
            ...
            <li>
              XORI: The XORI instruction performs bitwise “xor” between the values in registers Rs1
            ...
            <li>
              ORI: The ORI instruction performs bitwise “or” between the values in registers Rs1 and
              the sign-extended 12-bit immediate, writes the result into the destination register
              Rd.
            </li>
            <img src="/images/guide/i-type/ori-instruction.png" alt="ORI instruction" />

            <li>
              ANDI: The ANDI instruction performs bitwise “and” between the values in registers Rs1
              and the sign-extended 12-bit immediate, writes the result into the destination
              register Rd.
            </li>
            ...
            <li>
              SRLI: The SLLI perform logical right shifts on the value in register Rs1 by the shift
              amount held in the lower 5 bits of the sign-extended immediate, and writes the result
            ...
            <li>
              LW: The LW instruction loads 32-bit data from memory into the destination register Rd.
              The address is calculated by adding the value in Rs2 to an immediate value.
            </li>
            <img src="/images/guide/i-type/lw-instruction.png" alt="LW instruction" />

            <li>
              LH: The LH instruction loads 16-bit data from memory into the destination register Rd.
              The address is calculated by adding the value in Rs2 to an immediate value.
            </li>
            <img src="/images/guide/i-type/lh-instruction.png" alt="LH instruction" />

            <li>
              LB: The LB instruction loads 8-bit data from memory into the destination register Rd.
              The address is calculated by adding the value in Rs2 to an immediate value.
            </li>
          ...
          <ul className="list-disc space-y-2 pl-8">
            <li>
              ...
              current PC value and an immediate value if the values in Rs1 and Rs2 are equal. Using
              signed comparison.
            </li>
            ...
            <li>
              ...
              current PC value and an immediate value if the values in Rs1 is less than the value in
              Rs2. Using signed comparison.
            </li>
            ...
            <li>
              ...
              current PC value and an immediate value if the values in Rs1 is greater or euqal than
            ...
            <li>
              ...
              current PC value and an immediate value if the values in Rs1 is greater or euqal than
              the value in Rs2. Using usigned comparison.
            </li>
          ...
          <ul className="list-disc space-y-2 pl-8">
            ...
            <li>
              AUIPC: AUIPC creates a 32-bit offset from the 20-bit immediate[31:12], filling in the
              lowest 12 bits with zeros, adds this offset to the pc, and wirte the result in
              register rd.
            </li>
