        ...
        if (message == 'PUT') {
            ...
            if (dec('0' + address) < 399 && 0 <= dec('0' + address)) {
                ...
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                    ': CPU is sending PUT messeage to MEMORY',
                )
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                ...
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                    ': MEMORY is receiving PUT message from INTERCONNECT',
                )
                console.log(
                    'Cycle ',
                    this.cycle.toString(),
            ...
            if (dec('0' + address) < 499 && 400 <= dec('0' + address)) {
                ...
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                    ': CPU is sending PUT messeage to MONITOR',
                )
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                ...
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                    ': INTERCONNECT is sending messeage to MONITOR',
                )
                console.log(
                    'Cycle ',
                    this.cycle.toString(),
                ...
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                    ': MONITOR is receiving messeage from INTERCONNECT',
                )
                console.log(
                    'Cycle ',
                    this.cycle.toString(),
                ...
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                    ': MONITOR is sending ACCESS_ACK messeage to CPU',
                )
                console.log(
                    'Cycle ',
                    this.cycle.toString(),
                ...
                this.println(
                    'Cycle ',
                    this.cycle.toString(),
                    ': INTERCONNECT is receiving messeage from MONITOR',
                )
                console.log(
                    'Cycle ',
                    this.cycle.toString(),
