...
SOC.assemble(
   ...
   0xffffff, //Stack point
   //4095*0xffffff, //Stack point
   [],
    [
    [0, (0*4095) + (96 + 16 + 1024) *4, 1, 0],
    [1, (1*4095) + (96 + 16 + 1024) *4, 1, 1],
    [2, (2*4095) + (96 + 16 + 1024) *4, 1, 1],
    [3, (3*4095) + (96 + 16 + 1024) *4, 1, 1],
    [4, (4*4095) + (96 + 16 + 1024) *4, 1, 1],
    [5, (5*4095) + (96 + 16 + 1024) *4, 1, 1],
    [6, (6*4095) + (96 + 16 + 1024) *4, 1, 1],
    [244 , (244*4095) + (96 + 16 + 1024) *4, 1, 1], 
    [245 , (244*4095) + (96 + 16 + 1024) *4, 1, 1],
    [246 , (244*4095) + (96 + 16 + 1024) *4, 1, 1],
]   ,
    0xffffff,
)
SOC.RunAll()
